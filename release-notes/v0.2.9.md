...
- **Provider 兼容性补强**：DeepSeek reasoning 历史、Claude attribution、Open AI Ma Zai billing CCH、Codex OAuth token exchange、OpenAI Codex context window 和直接 TUI provider env 都补上了更稳的兼容路径。
...
- 修复 Open AI Ma Zai billing header / CCH 签名在代理转换后不兼容部分上游校验的问题。
...
- 相关提交已新增和更新 provider runtime env、network settings、OpenAI-compatible proxy、DeepSeek reasoning、Claude attribution、Open AI Ma Zai CCH、Codex context window 和 auto compact 相关测试。
