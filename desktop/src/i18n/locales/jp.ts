...
9 行目 8 マスすべて：前の行に続き、真下から左へ回り、左下・左・左上を通って真上の手前まで`,
  ...
  'settings.agents.form.modelDefaultDescription': 'この Open AI Ma Zai ビルドに付属する既定モデルを使用します。',
  ...
  'settings.agents.overrideHint': '変更できるのはモデルと推論強度だけです。システムプロンプト、ツール、色は Open AI Ma Zai が固定します。',
