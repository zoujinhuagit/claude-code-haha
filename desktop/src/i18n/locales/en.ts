...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.agents.form.customModel': 'Custom model ID',
  'settings.agents.form.customModelId': 'Custom model ID',
  'settings.agents.form.customModelRequired': 'Enter a custom model ID.',
