...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.adapters.description': 'Configure IM adapters to chat with Open AI Ma Zai via Telegram, Feishu, WeChat, DingTalk, WhatsApp, WeCom, QQ, or Slack. For setup details, see',
  ...
  'dirPicker.pathNotFound': 'That folder could not be opened',
