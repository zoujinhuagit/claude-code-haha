...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.adapters.description': '配置即时通讯适配器，通过 Telegram、飞书、微信、钉钉、WhatsApp、企业微信、QQ 或 Slack 与 Open AI Ma Zai 对话。首次配置请参考',
  ...
  'settings.agents.form.modelDefaultDescription': '使用此 Open AI Ma Zai 版本随附的默认模型。',
  ...
  'settings.agents.overrideHint': '只能修改模型和思考强度。系统提示词、工具和颜色由 Open AI Ma Zai 固定。',
  ...
  'contextIndicator.sessionTotalTokens': '新生成',
  ...
  'dirPicker.pathNotFound': '无法打开该文件夹',
