...
第 9 列 全 8 格：接著上一列，從正下方繼續向左轉，經過左下、左邊、左上，轉回接近正上方`,
  ...
  'settings.agents.form.customModel': '自訂模型 ID',
  'settings.agents.form.customModelId': '自訂模型 ID',
  'settings.agents.form.customModelRequired': '請輸入自訂模型 ID。',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '新建會話',
  'empty.subtitle': '開始一個新的編碼會話。Open AI Ma Zai 已準備好幫你構建、除錯和架構你的專案。',
  ...
  'chat.turnChangesPreviewOnlySubtitle': '檔案檢查點不完整，僅供預覽，無法安全復原',
  'chat.turnChangesRestoreUnavailable': '無法完整復原',
  ...
  'dirPicker.availableDrives': '切換磁碟機:',
