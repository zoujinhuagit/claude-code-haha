...
9번째 줄 8칸 전부: 앞 줄에 이어 정면 아래에서 왼쪽으로 돌아 왼쪽 아래, 왼쪽, 왼쪽 위를 지나 정면 위 직전까지`,
  ...
  'settings.agents.form.customModel': '사용자 지정 모델 ID',
  'settings.agents.form.customModelId': '사용자 지정 모델 ID',
  'settings.agents.form.customModelRequired': '사용자 지정 모델 ID를 입력하세요.',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '새 세션',
  'empty.subtitle': '새 코딩 세션을 시작합니다. Open AI Ma Zai가 프로젝트를 구축하고 디버깅하며 설계하도록 도울 준비가 되어 있습니다.',
