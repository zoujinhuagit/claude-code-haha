...
describe('Sidebar', () => {
  ...
  // had been dragged. Only one ships now — and the retired one must not linger
  // in the DOM, since a display-hidden copy still reaches screen readers and
  // in-page search.
  it('renders a single wordmark', () => {
    render(<Sidebar />)
  ...
  it('shows the brand mark only on the rail, where the wordmark is clamped away', async () => {
    ...
    // Scope to the wordmark's own row, so a looser query elsewhere in the
    // header can't answer for it.
