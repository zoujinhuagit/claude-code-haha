...
export const DESCRIPTION = 'Get or set Open AI Ma Zai configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Open AI Ma Zai configuration settings.

  View or change Open AI Ma Zai settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
