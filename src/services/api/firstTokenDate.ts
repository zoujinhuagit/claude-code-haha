...
/**
 * Fetch the user's first Open AI Ma Zai token date and store in config.
 * This is called after successful login to cache when they started using Open AI Ma Zai.
 */
