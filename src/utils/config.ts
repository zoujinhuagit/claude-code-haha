...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Open AI Ma Zai was first started on this machine
  ...
  // Open AI Ma Zai usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Open AI Ma Zai OAuth token
  ...
  // Open AI Ma Zai hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
