...
// Always ask when Open AI Ma Zai tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Open AI Ma Zai for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Open AI Ma Zai)
