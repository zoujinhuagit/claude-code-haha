...
const APP_NAME = 'Open AI Ma Zai URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Open AI Ma Zai URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Open AI Ma Zai Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Open AI Ma Zai
