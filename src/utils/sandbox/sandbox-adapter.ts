...
/**
 * Resolve Open AI Ma Zai-specific path patterns for sandbox-runtime.
 *
 * Open AI Ma Zai uses special path prefixes in permission rules:
...
/**
 * Convert Open AI Ma Zai settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Open AI Ma Zai started)
